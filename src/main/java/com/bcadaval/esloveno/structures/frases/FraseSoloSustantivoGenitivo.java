...
/**
 * Estructura de frase: Sustantivo en caso Genitivo
 * <p>
 * Ejemplo: "brez knjige" (sin libro), "od prijatelja" (del amigo)
 * <p>
 * El genitivo es uno de los casos más frecuentes en esloveno.
 * Se usa para:
 * - Posesión (hiša staršev - casa de los padres)
 * - Después de negación (nimam časa - no tengo tiempo)
 * - Con muchas preposiciones (iz, od, do, brez, pri, ...)
 * - Cantidades (kozarec vode - vaso de agua)
 * <p>
 * Elementos:
 * 1. NUMERO (apoyo): numeral que concuerda con el sustantivo
 * 2. SUSTANTIVO (slot): SustantivoFlexion con caso GENITIVO
 */
@Component
@ExcluirDeFrases(razon = "Estructura excluida temporalmente")
public class FraseSoloSustantivoGenitivo extends EstructuraFrase {

    @Getter
    private final String identificador = "SOLO_SUSTANTIVO_GENITIVO";
    @Getter
    private final String nombreMostrar = "Sustantivo (GEN)";

    public FraseSoloSustantivoGenitivo() {
        super();
    }
