...
/**
 * Estructura de frase: Adjetivo + Sustantivo en caso Genitivo
 * <p>
 * Ejemplo: "od starega prijatelja" (del viejo amigo), "brez dobre knjige" (sin un buen libro)
 * <p>
 * Esta estructura practica la concordancia adjetivo-sustantivo en genitivo,
 * esencial para expresar:
 * - Posesión: hiša starega moža (la casa del hombre viejo)
 * - Origen: iz velikega mesta (de la ciudad grande)
 * - Después de preposiciones: brez dobrega razloga (sin buena razón)
 * - Negación: nimam novega telefona (no tengo teléfono nuevo)
 * <p>
 * El genitivo es el caso más frecuente después del nominativo y acusativo.
 * <p>
 * Elementos:
 * 1. NUMERAL (apoyo): indica el número gramatical
 * 2. ADJETIVO (slot): AdjetivoFlexion en GENITIVO y grado POSITIVO
...
public class FraseAdjetivoSustantivoGenitivo extends EstructuraFrase {

    @Getter
    private final String identificador = "ADJETIVO_SUSTANTIVO_GENITIVO";
    @Getter
    private final String nombreMostrar = "Adjetivo + Sustantivo (GEN)";

    public FraseAdjetivoSustantivoGenitivo() {
        super();
    }

    @PostConstruct
    public void configurarEstructura() {
        // Definir slot de adjetivo en genitivo y grado positivo
